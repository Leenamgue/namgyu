...
<div class="container">
	...
	<form id="edit">
	  <div class="form-group row">
	    ...
	    <div class="col-xs-1">
	    	<button type="submit" class="btn btn-primary" id="submit" formaction="/web/insert">추가</button>
	    </div>
	    <div class="col-xs-1">
	    	<button type="submit" class="btn btn-success disabled" id="update" formaction="/web/update2">수정</button>
	    </div>
	    <div class="col-xs-1">
	    	<button type="submit" class="btn btn-danger disabled" id="delete" formaction="/web/delete2">삭제</button>
	    </div>
	  </div>
	</form>
</div>
